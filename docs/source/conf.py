...
project = u'Cartographer ROS for the Toyota HSR'
...
latex_documents = [
    ('index', 'CartographerROS.tex', u'Cartographer ROS for the Toyota HSR Documentation',
...
man_pages = [
    ('index', 'cartographer', u'Cartographer ROS for the Toyota HSR Documentation',
