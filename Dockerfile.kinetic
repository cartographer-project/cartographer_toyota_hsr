...
RUN cartographer_toyota_hsr/scripts/prepare_catkin_workspace.sh
RUN cartographer_toyota_hsr/scripts/install_debs.sh && rm -rf /var/lib/apt/lists/*
RUN cartographer_toyota_hsr/scripts/install.sh --pkg cartographer_toyota_hsr && \
    cartographer_toyota_hsr/scripts/install.sh --pkg cartographer_toyota_hsr \
        --catkin-make-args run_tests && \
    cartographer_toyota_hsr/scripts/catkin_test_results.sh build_isolated/cartographer_toyota_hsr

COPY scripts/ros_entrypoint.sh /
# A BTRFS bug may prevent us from cleaning up these directories.
# https://btrfs.wiki.kernel.org/index.php/Problem_FAQ#I_cannot_delete_an_empty_directory
RUN rm -rf cartographer_toyota_hsr catkin_ws || true
